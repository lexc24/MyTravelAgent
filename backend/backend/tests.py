...
class DebugSettingsTests(TestCase):
    ...
    def test_debug_allowed_hosts(self):
        ...
        self.assertTrue(
            ...
            or "testserver" in settings.ALLOWED_HOSTS
        )
...
class ProductionSettingsTests(TestCase):
    ...
    @override_settings(DEBUG=False, ALLOWED_HOSTS=[".onrender.com", "localhost"])
...
class CORSConfigurationTests(TestCase):
    ...
    @override_settings(
        DEBUG=False, CORS_ALLOWED_ORIGINS=["https://my-travel-agent.onrender.com"]
    )
    def test_production_cors_origins(self):
        """Test CORS origins in production"""
        self.assertIn(
            "https://my-travel-agent.onrender.com", settings.CORS_ALLOWED_ORIGINS
        )
...
class AuthenticationIntegrationTests(APITestCase):
    ...
    def test_complete_auth_flow(self):
        ...
        token_data = {"username": "newuser", "password": "newpass123"}
