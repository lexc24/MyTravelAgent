...
SECRET_KEY = os.environ.get('SECRET_KEY', default='your-current-secret-key')
...
if os.environ.get('DATABASE_URL'):
    ...
    # Keep your existing Docker database config
...
if DEBUG:
    ...
    CORS_ALLOWED_ORIGINS = [
        "https://my-travel-agent.onrender.com",  # Update after frontend deployment
    ]
