...
class Destination(models.Model):
    ...
    average_cost_per_day = models.DecimalField(
...
class PlanningSession(models.Model):
    ...
    trip = models.ForeignKey(
        Trip, on_delete=models.CASCADE, related_name="planning_sessions"
    )
    ...
    current_stage = models.CharField(
        max_length=20, choices=PLANNING_STAGES, default="destination"
    )
