...
const RecommendationChat = () => {
  ...
  const resetConversation = async () => {
    if (
      window.confirm(
        "Are you sure you want to start over? This will clear all your preferences."
      )
    ) {
      try {
    ...
    const steps = [
      {
        ...
        status: currentStage !== "initial" ? "complete" : "current",
      },
      {
      ...
      },
      {
        ...
        status:
          currentStage === "destinations_complete"
            ? "current"
            ...
            >
              <Stack gap={5}>
                ...
                >
                  ...
                  <h2 style={{ margin: 0 }}>
                    {tripTitle} - Destination Discovery
                  </h2>
                  <Button
                    kind="ghost"
                    size="sm"
                ...
                >
                  <ProgressIndicator
                    currentIndex={getProgressSteps().findIndex(
                      (s) => s.status === "current"
                    )}
                    spaceEqually
                    style={{ flex: 1 }}
                ...
                <Layer>
                  ...
                  >
                    ...
                    <p style={{ margin: "1rem 0" }}>
                      Tell me about your dream vacation. What kind of experience
                      are you looking for?
                    </p>
                    <Stack
                      gap={3}
                    ...
                    >
                      <Button
                        ...
                        onClick={() =>
                          setInputValue(
                            "I want a relaxing beach vacation with great food"
                          )
                        }
                      >
                        Beach & Relaxation
                      ...
                      <Button
                        ...
                        onClick={() =>
                          setInputValue(
                            "I'm looking for adventure and outdoor activities"
                          )
                        }
                      >
                        Adventure & Nature
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          setInputValue("I want to explore culture and history")
                        }
                      >
                        Culture & History
                      </Button>
              ...
              <Stack gap={4}>
                {messages.map((message) => (
                  <div
                    ...
                    style={{
                      display: "flex",
                      justifyContent: message.is_user
                        ? "flex-end"
                        : "flex-start",
