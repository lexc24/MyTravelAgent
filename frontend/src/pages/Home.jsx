    ...
    try {
      ...
      if (token) {
        try {
          ...
          const possibleUsername = decoded.username || decoded.user_name || decoded.name || decoded.sub || decoded.email;
          
          if (possibleUsername) {
            // Capitalize first letter of username
            const capitalizedUsername = possibleUsername.charAt(0).toUpperCase() + possibleUsername.slice(1);
            ...
            try {
              ...
              if (response.data.username) {
                const capitalizedUsername = response.data.username.charAt(0).toUpperCase() + response.data.username.slice(1);
                setUsername(capitalizedUsername);
              }
            } catch (apiError) {
